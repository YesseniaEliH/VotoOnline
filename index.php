...
<div class="wrapper bgded overlay widthYess" style="background-image:url('images/voto.jpeg');">
  <section id="testimonials" class="hoc container clear">
    ...
    <ul class="nospace group">
      <li class="one_half">
        <blockquote> "VOTO ONLINE" <br>
        Es una forma de votación web que permite a los votantes elegir a la <strong> junta directiva </strong> de una organización emitiendo su voto de forma privada y fácil desde cualquier lugar y cualquier dispositivo con acceso a Internet (PC, tablet, smartphone, etc.), garantizando un máximo de participación y permitiendo a los votantes remotos y a personas con discapacidad participar en igualdad de condiciones.</blockquote>
      </li>
    </ul>
  </section>
</div>
