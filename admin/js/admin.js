...
var errorMessage="";
var okayMessage="Presiona ACEPTAR para continuar";
...
var validationVerified=true;
var errorMessage="";
var okayMessage="click OK para agregar nuevo candidato";

if (candidateForm.name.value == "")
{
  errorMessage+="Por favor ingrese el nombre del candidato!\n";
  validationVerified=false;
}
if (candidateForm.position.selectedIndex == 0)
{
  errorMessage+="Puesto de candidato no seleccionado!\n";
  validationVerified=false;
}
if(!validationVerified)
{
...
//validate user form
function userValidate(userForm){

  var validationVerified=true;
  var errorMessage="";
  var okayMessage="click OK para agregar nuevo votante";

  if (userForm.firstname.value == "")
  {
    errorMessage+="Por favor ingrese el nombre del votante!\n";
    validationVerified=false;
  }
  if (userForm.lastname.value == "")
  {
    errorMessage+="Por favor ingrese los apellidos del votante!\n";
    validationVerified=false;
  }
  if (userForm.email.value == "")
  {
    errorMessage+="Por favor ingrese el email del votante!\n";
    validationVerified=false;
  }
  if (userForm.voter_id.value == "")
  {
    errorMessage+="Por favor ingrese el id de votante!\n";
    validationVerified=false;
  }
...
var validationVerified=true;
var errorMessage="";
var okayMessage="Clic en ACEPTAR para ver los resultados del puesto seleccionado.";
